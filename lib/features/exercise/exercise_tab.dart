  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return BentoBackground(
      ...
      child: linkedHabit == null
          ? _GateScreen(habits: habits)
          : _ExerciseContent(habit: linkedHabit),
    );
  }
}
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _StreakCard(streak: stats.streakDays)),
              const SizedBox(width: 10),
              Expanded(
                child: _StatCard(
                  icon: Icons.speed,
                  accent: BentoTheme.accentPurple,
                  value: stats.avgPace30 == null
                      ? '—'
                      : stats.avgPace30!.toStringAsFixed(2),
